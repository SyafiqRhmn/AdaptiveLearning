...
<div class="container my-5">
    <div class="row">
        <div class="col-8">
            <form method="POST" action="{{ route('pre-test.store') }}" class="p-1">
                @csrf
                <div class="form-group mb-3">
                    <label for="name" class="form-label">Nama Pre Test</label>
                ...
                <div>
                    <a href="{{ route('pre-test.index') }}" class="btn btn-danger"><i class="bi bi-back"></i>  Back</a>
