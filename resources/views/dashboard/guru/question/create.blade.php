    ...
    <div class="row">
        <div class="col-8">
            ...
            <form method="POST" action="{{ route('question.store') }}">
                ...
                <div class="form-group" id="div_testable_pre" {{ old('testable_type') !== 'post-test' ? 'hidden' : '' }}>
                ...
                <div class="form-group div_testable_post" id="div_testable_post" {{ old('testable_type') !== 'pre-test' ? 'hidden' : '' }}>
                ...
                <a href="{{ route('question.index') }}" class="btn btn-danger"><i class="bi bi-back"></i> Batal</a>
