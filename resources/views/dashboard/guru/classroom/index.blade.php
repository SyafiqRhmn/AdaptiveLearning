...
<div class="wrapper d-flex align-items-stretch">
  ...
  <div id="content" class="p-md-3">
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col">
              <a href="{{ route('classroom.create') }}" class="mt-4 btn btn-primary">Tambah classroom</a>
              @if (session('success'))
                    ...
                    <tbody>
                      @foreach ($classrooms as $classroom)    
                        <tr>
                          ...
                          <td>
                            <a title="edit data" href="{{ route('classroom.edit', $classroom->id) }}" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
                            <form action="{{ route('classroom.destroy', $classroom->id) }}" class="d-inline" method="POST">
                              @csrf
                              @method('DELETE')
